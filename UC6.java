...
public class UC6 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("(Inches + Feet): " + demonstrateLengthAddition(l3, l4));

        Length l5 = new Length(1.0, Length.LengthUnit.YARDS);
        Length l6 = new Length(3.0, Length.LengthUnit.FEET);

        System.out.println("(Yards + Feet): " + demonstrateLengthAddition(l5, l6));
